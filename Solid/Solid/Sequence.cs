...
namespace Solid
{
	public static class Sequence
	{
		...
		/// Empty Sequence objects of different generic types may or may not be reference equal."/></remarks>
		...
		: IEnumerable<T>
	{
		...
		public Sequence<TOut> Apply<TOut>(Func<T, TOut> transform)
		{
			...
			var newRoot = FTree<Value<TOut>>.Empty;
		...
		public Sequence<T> Append(Sequence<T> other)
		{
			...
			var result = FTree<Value<T>>.Concat(root, other.root);
		...
		public Sequence<T> Insert(int index, T item)
		{
			...
			var result = FTree<Value<T>>.Concat(part1, part2);
			return new Sequence<T>(result);
		}
		...
		/// <summary>
		///   Concatenates two Sequence data structures.
		/// </summary>
		/// <param name="first"> </param>
		/// <param name="second"> </param>
		/// <returns> </returns>
		public static Sequence<T> operator &(Sequence<T> first, Sequence<T> second)
		{
			return first.Append(second);
		}

		/// <summary>
		///   Adds an item to the end of this Sequence object.
		/// </summary>
		...
		{
			return seq.AddLast(item);
		}

		/// <summary>
		///   Adds an item to the beginning of this Sequence object.
		/// </summary>
		/// <param name="item"> </param>
		/// <param name="seq"> </param>
		/// <returns> </returns>
