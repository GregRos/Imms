...
namespace Solid.Builders
{
		...
		: IEnumerable<T>
	{
		...
		{
			private Vector<T> _cache;
			private bool _done;
			private readonly IEnumerator<T> _inner;
			private readonly VectorBuilder<T> _parent;

			public CachingEnumerator(VectorBuilder<T> parent, IEnumerable<T> source)
			{
				_parent = parent;
				_cache = Vector<T>.Empty;
		...
		internal VectorBuilder(IEnumerable<T> source)
		{
		...
		/// <returns> </returns>
		public static implicit operator Vector<T>(VectorBuilder<T> delayed)
		{
		...
		private void Commit(Vector<T> result)
		{
		...
		/// </summary>
		/// <returns> </returns>
		public VectorBuilder<T> DefaultIfEmpty()
		{
			return new VectorBuilder<T>(Source.DefaultIfEmpty());
		}
		...
		/// <returns> </returns>
		public VectorBuilder<T> DefaultIfEmpty(T value)
		{
			return new VectorBuilder<T>(Source.DefaultIfEmpty(value));
		}
		...
		/// </summary>
		/// <returns> </returns>
		public VectorBuilder<T> Distinct()
		{
			return new VectorBuilder<T>(Source.Distinct());
		}
		...
		/// <returns> </returns>
		public VectorBuilder<T> Distinct(IEqualityComparer<T> comparer)
		{
			return new VectorBuilder<T>(Source.Distinct(comparer));
		}
		...
		/// <returns> </returns>
		public VectorBuilder<IGrouping<TKey, T>> GroupBy<TKey>(Func<T, TKey> keySelector)
		{
			return new VectorBuilder<IGrouping<TKey, T>>(Source.GroupBy(keySelector));
		}
		...
		/// <returns> </returns>
		public VectorBuilder<IGrouping<TKey, TElement>> GroupBy<TKey, TElement>(Func<T, TKey> keySelector,
		                                                                      Func<T, TElement> resultSelector)
		{
			return new VectorBuilder<IGrouping<TKey, TElement>>(Source.GroupBy(keySelector, resultSelector));
		}
		...
		/// <param name="resultSelector"> The result selector. </param>
		/// <returns> </returns>
		public VectorBuilder<TResult> GroupBy<TKey, TResult>(Func<T, TKey> keySelector,
		                                                   Func<TKey, IEnumerable<T>, TResult> resultSelector)
		{
			return new VectorBuilder<TResult>(Source.GroupBy(keySelector, resultSelector));
		}
		...
		/// <param name="resultSelector"> The result selector. </param>
		/// <returns> </returns>
		public VectorBuilder<TResult> GroupBy<TKey, TElement, TResult>(Func<T, TKey> keySelector,
		                                                             Func<T, TElement> elementSelector,
		                                                             Func<TKey, IEnumerable<TElement>, TResult>
			                                                             resultSelector)
		{
			return new VectorBuilder<TResult>(Source.GroupBy(keySelector, elementSelector, resultSelector));
		}
		...
		/// <param name="resultSelector"> The result selector. </param>
		/// <returns> </returns>
		public VectorBuilder<TResult> Join<TInner, TKey, TResult>
			(IEnumerable<TInner> inner, Func<T, TKey> outerSelector, Func<TInner, TKey> innerSelector,
			 Func<T, TInner, TResult> resultSelector)
		{
			return new VectorBuilder<TResult>(Source.Join(inner, outerSelector, innerSelector, resultSelector));
		}
		...
		/// <param name="keySelector"> The key selector. </param>
		/// <returns> </returns>
		public VectorBuilder<T> OrderBy<TKey>(Func<T, TKey> keySelector)
		{
			return new VectorBuilder<T>(Source.OrderBy(keySelector));
		}
		...
		/// <param name="keySelector"> The key selector. </param>
		/// <returns> </returns>
		public VectorBuilder<T> OrderByDescending<TKey>(Func<T, TKey> keySelector)
		{
			return new VectorBuilder<T>(Source.OrderByDescending(keySelector));
		}
		...
		/// <param name="resultSelector"> The result selector. </param>
		/// <returns> </returns>
		public VectorBuilder<TResult> OuterJoin<TInner, TKey, TResult>(IEnumerable<TInner> inner,
		                                                             Func<T, TKey> outerSelector,
		                                                             Func<TInner, TKey> innerSelector,
		                                                             Func<T, IEnumerable<TInner>, TResult>
			                                                             resultSelector)
		{
			return new VectorBuilder<TResult>(Source.GroupJoin(inner, outerSelector, innerSelector, resultSelector));
		}
		...
		/// <returns> </returns>
		public VectorBuilder<TResult> Select<TResult>(Func<T, TResult> selector)
		{
			return new VectorBuilder<TResult>(Source.Select(selector));
		}
		...
		/// <param name="selector"> The selector. </param>
		/// <returns> </returns>
		public VectorBuilder<TResult> SelectMany<TResult>(Func<T, IEnumerable<TResult>> selector)
		{
			return new VectorBuilder<TResult>(Source.SelectMany(selector));
		}
		...
		/// <param name="resultSelector"> The result selector. </param>
		/// <returns> </returns>
		public VectorBuilder<TResult> SelectMany<TCollect, TResult>(Func<T, IEnumerable<TCollect>> manySelector,
		                                                          Func<T, TCollect, TResult> resultSelector)
		{
			return new VectorBuilder<TResult>(Source.SelectMany(manySelector, resultSelector));
		}
		...
		/// <returns> </returns>
		public VectorBuilder<T> Skip(int count)
		{
			return new VectorBuilder<T>(Source.Skip(count));
		}
		...
		/// <returns> </returns>
		public VectorBuilder<T> SkipWhile(Func<T, bool> predicate)
		{
			return new VectorBuilder<T>(Source.SkipWhile(predicate));
		}
		...
		/// <returns> </returns>
		public VectorBuilder<T> Take(int count)
		{
			return new VectorBuilder<T>(Source.Take(count));
		}
		...
		/// <param name="predicate"> The predicate. </param>
		/// <returns> </returns>
		public VectorBuilder<T> TakeWhile(Func<T, bool> predicate)
		{
			return new VectorBuilder<T>(Source.TakeWhile(predicate));
		}
		...
		/// <param name="predicate"> The predicate. </param>
		/// <returns> </returns>
		public VectorBuilder<T> Where(Func<T, bool> predicate)
		{
			return new VectorBuilder<T>(Source.Where(predicate));
		}
		...
		/// <param name="predicate"> The predicate. </param>
		/// <returns> </returns>
		public VectorBuilder<T> Where(Func<T, int, bool> predicate)
		{
			return new VectorBuilder<T>(Source.Where(predicate));
		}
	}
