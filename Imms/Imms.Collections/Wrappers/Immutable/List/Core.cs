...
namespace Imms {
	...
	public sealed partial class ImmList<T> : AbstractSequential<T, ImmList<T>> {
		...
		///     <para>⚡ O(logm) </para>
		/// </summary>
		/// <param name="last">The list to add to the end.</param>
		/// <returns></returns>
		public ImmList<T> AddLastRange(ImmList<T> last) {
