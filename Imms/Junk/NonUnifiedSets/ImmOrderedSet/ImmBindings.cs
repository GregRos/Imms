...
namespace Imm.Collections
{
	public partial class ImmOrderedSet<T>
	{
		internal class Builder : SetBuilder<T>
		{
			...
			public Builder(ImmOrderedSet<T> map)
		...
		protected override ImmOrderedSet<T> ProviderFrom(SetBuilder<T> builder)
		{
			return (ImmOrderedSet<T>)builder.Result;
		}

		protected override SetBuilder<T> BuilderFrom(ImmOrderedSet<T> provider)
		{
