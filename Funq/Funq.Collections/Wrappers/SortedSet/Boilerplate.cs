...
namespace Funq.Collections
{
	...
	public partial class FunqOrderedSet<T> : Trait_SetLike<T, FunqOrderedSet<T>>
	{
		...
		{
			return FunqOrderedSet<TElem2>.Empty(ph);
		}
		...
		/// <returns></returns>
		public FunqOrderedSet<TRElem> Select<TRElem>(Func<T, TRElem> selector, IComparer<TRElem> handler)
		{
		...
		/// <param name="handler">A new equality or comparison handler for constructing the resulting set.</param>
		/// <returns></returns>
		public FunqOrderedSet<TRElem> Select<TRElem>(Func<T, Option<TRElem>> selector, IComparer<TRElem> handler)
		{
			if (selector == null) throw Errors.Is_null;
		...
		/// <returns></returns>
		public FunqOrderedSet<TRElem> Cast<TRElem>(IComparer<TRElem> handler)
		{
			return Cast<TRElem, FunqOrderedSet<TRElem>>(GetPrototype<TRElem>(handler));
		}
		...
		/// <param name="handler">The handler.</param>
		/// <returns></returns>
		public FunqOrderedSet<TRElem> OfType<TRElem>(IComparer<TRElem> handler) 
		{
			return OfType<TRElem, FunqOrderedSet<TRElem>>(GetPrototype<TRElem>(handler));
		}
		...
		/// <param name="handler">A new equality or comparison handler for constructing the resulting set.</param>
		/// <returns></returns>
		public FunqOrderedSet<TRElem> Scan<TRElem>(TRElem initial, Func<TRElem, T, TRElem> accumulator, IComparer<TRElem> handler)
		{
