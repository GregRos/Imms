...
public partial class __ListLikeClass__<T> : Trait_Sequential<T, __ListLikeClass__<T>> {
	...
	{
		return __ListLikeClass__<TElem2>._instance;
	}
	...
	/// <param name="selector">The selector.</param>
	/// <returns></returns>
	public __ListLikeClass__<TRElem> Select<TRElem>(Func<T, Option<TRElem>> selector)
	{
		if (selector == null) throw Errors.Is_null;
	...
	/// <param name="selector">The selector.</param>
	/// <returns></returns>
	public __ListLikeClass__<TRElem> Choose<TRElem>(Func<T, Option<TRElem>> selector)
	{
		if (selector == null) throw Errors.Is_null;
		return base.Choose(this.GetPrototype<TRElem>(), selector);
	}
	...
	public __ListLikeClass__<TRElem> OfType<TRElem>()
	{
		
		return base.OfType<TRElem, __ListLikeClass__<TRElem>>(GetPrototype<TRElem>());
	}
