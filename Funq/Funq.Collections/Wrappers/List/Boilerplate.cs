...
namespace Funq.Collections
{
	...
	public partial class FunqList<T> : Trait_Sequential<T, FunqList<T>> {
		private static readonly FunqList<T> _instance = new FunqList<T>();
		...
		{
			return FunqList<TElem2>._instance;
		}
		...
		/// <param name="selector">The selector.</param>
		/// <returns></returns>
		public FunqList<TRElem> Select<TRElem>(Func<T, Option<TRElem>> selector)
		{
			if (selector == null) throw Errors.Is_null;
		...
		/// <param name="selector">The selector.</param>
		/// <returns></returns>
		public FunqList<TRElem> Choose<TRElem>(Func<T, Option<TRElem>> selector)
		{
			if (selector == null) throw Errors.Is_null;
			return base.Choose(this.GetPrototype<TRElem>(), selector);
		}
		...
		public FunqList<TRElem> OfType<TRElem>()
		{
			
			return base.OfType<TRElem, FunqList<TRElem>>(GetPrototype<TRElem>());
		}
