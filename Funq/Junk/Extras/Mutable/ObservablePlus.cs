...
namespace Funq.Collections.Mutable
{
	...
	public class ObservablePlus<T> {
		public class HistoryEntry {
			public HistoryEntry(ChangeMarker<T> metadata, FunqList<T> snapshot, int index) {
				Snapshot = snapshot;
				Index = index;
				Metadata = metadata;
			}
		...
		FunqList<HistoryEntry> _history;
		FunqList<T> _current;
